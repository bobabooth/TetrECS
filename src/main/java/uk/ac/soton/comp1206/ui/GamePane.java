...
public class GamePane extends StackPane {
    ...
    /**
     * Use a Graphics Transformation to scale everything inside this pane
     * Padding is added to the edges to maintain the correct aspect ratio and keep the display centered
     */
    @Override
